...
public:
  ...
  fake_rate_reader( TString year , TString ele_WP, TString muon_WP, TString kind, uint nLeptons, TString electron_tight_charge );
  ...
  float operator()(RVecI Lepton_pdgId,
    ...
    for (unsigned int i = 0; i < nLeptons_ ; i++) {
      if (TMath::Abs(Lepton_pdgId[i]) == 11)
        if (Lepton_isTightElectron_mvaFall17V2Iso_WP90[i] == 1) 
	  isTight_[i] = 1;
      if (TMath::Abs(Lepton_pdgId[i]) == 13)
        if (Lepton_isTightMuon_cut_Tight_HWWW[i] == 1) 
	  isTight_[i] = 1;
    }
...
fake_rate_reader::fake_rate_reader( TString year , TString ele_WP, TString muon_WP, TString kind, uint nLeptons, TString electron_tight_charge ){
  ...
  TString fake_muon_file_name_20 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonFR_jet20.root";
  TString fake_muon_file_name_25 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonFR_jet25.root";
  TString fake_muon_file_name_30 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonFR_jet30.root";
  TString fake_muon_file_name_35 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonFR_jet35.root";
  TString fake_muon_file_name_45 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonFR_jet45.root";

  TString fake_ele_file_name_25  = mkShapesRDF_base + "/data/fakerate/" + year + "/cutBased_" + ele_tight_suffix + "_tthMVA_" + ele_WP  + "/EleFR_jet25.root";
  TString fake_ele_file_name_35  = mkShapesRDF_base + "/data/fakerate/" + year + "/cutBased_" + ele_tight_suffix + "_tthMVA_" + ele_WP  + "/EleFR_jet35.root";
  TString fake_ele_file_name_45  = mkShapesRDF_base + "/data/fakerate/" + year + "/cutBased_" + ele_tight_suffix + "_tthMVA_" + ele_WP  + "/EleFR_jet45.root";
  
  // Prompt rate input files
  TString pr_muon_file_name = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_tthmva_" + muon_WP + "/MuonPR.root";
  TString pr_ele_file_name =  mkShapesRDF_base + "/data/fakerate/" + year + "/cutBased_" + ele_tight_suffix + "_tthMVA_" + ele_WP  + "/ElePR.root";

  
  //if (year_ == "2024" || year_ == "2023BPix"){
    
    //fake_muon_file_name_10 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet10.root";
    //fake_muon_file_name_15 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet15.root";
    //fake_muon_file_name_20 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet20.root";
    //fake_muon_file_name_25 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet25.root";
    //fake_muon_file_name_30 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet30.root";
    //fake_muon_file_name_35 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet35.root";
    //fake_muon_file_name_45 = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonFR_jet45.root";
    
    //pr_muon_file_name = mkShapesRDF_base + "/data/fakerate/" + year + "/cut_TightID_pfIsoLoose_HWW_PNet/MuonPR.root";
  //}
