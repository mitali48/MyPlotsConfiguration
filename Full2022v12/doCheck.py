...
def run(submit=False, onlySample=None):
    ...
    path = prePath + "mkShapesRDF/examples/PlotsConfigurationsRun3/ggH/Full2022v12/condor/EGamma_Run2022D-ReReco-v1/"
    ...
    for fname in fnames:
        ...
        file_name = output_path + "/mkShapes__HWW_2022__ALL__" + fname + ".root"
