...
def run(submit=False, onlySample=None):
    ...
    path = prePath + "mkShapesRDF/examples/PlotsConfigurationsRun3/ggH/Full2023BPixv12/condor/EGamma1_Run2023D-Prompt-v2/"
    ...
    fnames = [fname.decode('ascii').split("EGamma1_Run2023D-Prompt-v2/")[1] for fname in fnames]
    ...
    for fname in fnames:
        ...
        file_name = output_path + "/mkShapes__HWW_2023BPix__ALL__" + fname + ".root"
